...
require('packer').startup(function(use)
  ...
  use 'lewis6991/impatient.nvim' -- Lua accelarator
...
keymap.set({'n', 'x'}, 'x', '"_x', {desc = 'Delete text without altering the record text.'})
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>D', lsp.buf.type_definition, 'Type [D]efinition')
